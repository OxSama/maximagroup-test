...
import TableCheckboxCell from "@/components/TableCheckable.vue";
...
<template>
    ...
    <CardBoxModal v-model="isModalDangerActive" title="Please confirm" has-cancel>
        <p>Lorem ipsum dolor sit amet <b>adipiscing elit</b></p>
        <p>This is sample modal</p>
    </CardBoxModal>
    ...
    <table>
        ...
        <tbody>
            <tr v-for="client in itemsPaginated" :key="client.id">
                ...
                <td>
                    <BaseButtons>
                        <BaseButton @click="isModalActive = true" />
                        <BaseButton @click="isModalDangerActive = true" />
                    </BaseButtons>
                </td>
            </tr>
        </tbody>
